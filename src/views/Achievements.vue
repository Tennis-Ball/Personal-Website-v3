...
<template>
	...
	<div class="text-3xl font-bold mb-2 mt-10">2021-2022 (10th grade)</div>
	<hr />
	<div class="flex flex-row flex-wrap">
		<Card icon="math" title="2022 AIME Qualifier">
			...
			Competitions) 10A (6th place nationally) and 118.5/150 on the AMC 12B.
		</Card>
	</div>

	<div class="text-3xl font-bold mb-2 mt-10">2020-21 (9th grade)</div>
	<hr />
	<div class="flex flex-row flex-wrap">
		<Card
			icon="math"
		...
		>
			I qualified for the 2021 USAJMO (USA Junior Mathematical Olympiad) by
			scoring 10/15 on the AIME I and having a qualification index of 241. I
			also scored 7/42 on the USAJMO.
		</Card>
		...
		>
			I was promoted to the Platinum Division of the USACO (USA Computing
			Olympiad) in the 2020-21 January Contest by scoring 917/1000.
		</Card>
		<Card icon="chem" title="2021 USNCO National Exam Qualifier">
		...
		>
			I received a Gold Medal in the Intermediate Division of the 2021 ACSL
			(American Computer Science League) Finals by receiving perfect scores in
			both the short answer and programming sections.
		</Card>
		<Card icon="math" title="2021 AIME Qualifier">
			I qualified for the 2021 AIME by scoring 141/150 on the AMC 10A and
			117/150 on the AMC 10B.
		</Card>
		<Card
			icon="code"
	...
	<div class="text-3xl font-bold mt-10 mb-2">2019-20 (8th grade)</div>
	<hr />
	<div class="flex flex-row flex-wrap">
		<Card title="2020 AIME Qualifier" icon="math">
			I qualified for the 2020 AIME by scoring 109.5 on the 2020 AMC 10A. I
			scored 7/15 on the AIME I.
		</Card>
	</div>
</template>
